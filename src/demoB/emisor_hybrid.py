...
class EmisorHybrid(slixmpp.ClientXMPP):
    def __init__(self, jid, password, recipient, sig_alg, kem_alg, my_keyring, peer_pub, out_csv):
    ...
    async def start(self, _):
        ...
        ok = 0
        try:
            ok = 1 if await asyncio.wait_for(self.reply_future, timeout=5.0) else 0
